...
namespace TGS {
    ...
    public partial class TerrainGridSystem : MonoBehaviour {
        ...
        public void ExportTerritoryMesh(int territoryIndex, int regionIndex = 0) {
            if (territoryIndex < 0 || territories == null || territoryIndex >= territories.Count || regionIndex < 0 || regionIndex >= territories[territoryIndex].regions.Count) return;
        ...
        public List<Vector2> TerritoryGetFrontier(int territoryIndex, int regionIndex) {
            if (territoryIndex < 0 || territories == null || territoryIndex >= territories.Count || regionIndex < 0 || regionIndex >= territories[territoryIndex].regions.Count) return null;
