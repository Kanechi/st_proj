...
namespace UniRx.WebRequest {
    public static class ObservableWebRequest {
        ...
        public static IObservable<string> Get(string url, IDictionary<string, string> headers = null, IProgress<float> progress = null) {
            return ObservableUnity.FromCoroutine<string>((observer, cancellation) => FetchText(UnityWebRequest.Get(url), headers, observer, progress, cancellation));
        }
...
#if true
        public static IObservable<UnityWebRequest> GetTexture(string url, IDictionary<string, string> headers = null, IProgress<float> progress = null) {
            return ObservableUnity.FromCoroutine<UnityWebRequest>((observer, cancellation) => Fetch(UnityWebRequestTexture.GetTexture(url), headers, observer, progress, cancellation));
        }
#endif

#if false
        public static IObservable<UnityWebRequest> GetTexture(string url, IDictionary<string, string> headers = null, IProgress<float> progress = null) {
            return ObservableUnity.FromCoroutine<UnityWebRequest>((observer, cancellation) => FetchText(UnityWebRequestTexture.GetTexture(url), headers, observer, progress, cancellation));
        }
#endif
